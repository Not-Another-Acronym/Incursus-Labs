...
class specialwiki_Userrights extends pageTest {
	function __construct() {
		...
		$this->params = array (
				...
				'saveusergroups' => wikiFuzz::chooseInput( array( "0", "1", "++--34234", wikiFuzz::makeFuzz( 2 ) ), "Save wiki_User Groups" ),
