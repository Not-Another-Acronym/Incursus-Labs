...
'nosuchuser' => 'Няма ўдзельніка з імем "$1". Праверце правільнасць напісання або [[Special:wiki_UserLogin/signup|стварыце новы рахунак]]. Вялікія і малыя літары ў такіх імёнах лічацца рознымі.',
...
'editinguser' => "Змена праў удзельніка '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'Належыць [[Special:wiki_UserLogin|увайсці ў сістэму]] на рахунак адміністратара, каб прызначаць дазволы ўдзельнікам.',
...
'revertpage-nouser' => 'Праўкі (імя ўдзельніка выдалена) адкочаны да версіі [[wiki_User:$1|$1]]',
