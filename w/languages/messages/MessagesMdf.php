...
'editinguser' => "'''[[wiki_User:$1|$1]]'''-нь тиить видексонзон полафнема ([[wiki_User talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
...
'userrights-nologin' => 'Тондейть эряви [[Special:wiki_UserLogin|сувамс]] оцюнянь сёрматфтомать вельде тиихнень видексснон макссеманкса.',
...
'statistics-users' => 'Сёрматфтф [[Special:Listwiki_Users|тиихне]]',
