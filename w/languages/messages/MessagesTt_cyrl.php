...
'editinguser' => "'''[[wiki_User:$1|$1]]''' кулланучысының хокукларын үзгәртү ([[wiki_User talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
...
'statistics-users' => 'Теркәлгән [[Special:Listwiki_Users|кулланучылар]]',
