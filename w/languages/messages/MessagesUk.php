...
'editinguser' => "Зміна прав користувача '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'Ви повинні [[Special:wiki_UserLogin|ввійти до системи]] з обліковим записом адміністратора, щоб призначати права користувачам.',
...
'statistics-users' => 'Зареєстрованих [[Special:Listwiki_Users|користувачів]]',
...
'revertpage-nouser' => "Відкинуто редагування (ім'я користувача приховано) до зробленого [[wiki_User:$1|$1]]",
