...
'editinguser' => "Изменение прав {{GENDER:$1|участника|участницы}} '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'Вы должны [[Special:wiki_UserLogin|представиться системе]] с учётной записи администратора, чтобы присваивать права участникам.',
...
'statistics-users' => 'Зарегистрированные [[Special:Listwiki_Users|участники]]',
...
'revertpage-nouser' => 'Правки (имя участника удалено) откачены к версии [[wiki_User:$1|$1]]',
