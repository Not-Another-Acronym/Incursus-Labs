...
'nosuchuser' => 'Не екзістує хоснователь з меном «$1». У хосновательскых мен ся розлишують малы/великы писмена. Сконтролюйте запис, або собі [[Special:wiki_UserLogin/signup|зареґіструйте нове конто]].',
...
'editinguser' => "Зміна прав хоснователя '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'Мусите ся [[Special:wiki_UserLogin|приголосити]] на конто адміністратора, жебы сьте могли мінити права хоснователїв.',
...
'statistics-users' => 'Реґістрованы [[Special:Listwiki_Users|хоснователї]]',
...
'revertpage-nouser' => 'Едітованя хоснователя (мено хоснователя є сховане) вернуты до минулого ставу, котрого автором є „[[wiki_User:$1|$1]]“',
