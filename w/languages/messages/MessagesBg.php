...
'editinguser' => "Промяна на потребителските права на потребител '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'За управление на потребителските права е необходимо [[Special:wiki_UserLogin|влизане]] с администраторска сметка.',
...
'statistics-users' => 'Регистрирани [[Special:Listwiki_Users|потребители]]',
...
'revertpage-nouser' => 'Премахнати редакции на (отстранено потребителско име) и връщане към последната версия на [[wiki_User:$1|$1]]',
