...
'editinguser' => "Ἀλλἀττειν τὰ δικαιώματα τοῦ χρωμένου '''[[wiki_User:$1|$1]]''' ([[wiki_User talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
...
'userrights-nologin' => 'Δεῖ σε [[Special:wiki_UserLogin|συνδεῖσθαι]] μετὰ ἐπιτρόπου λογισμοῦ τινὸς πρὸ τοῦ μεταγράφειν τὰ δικαιώματα χρωμένου.',
...
'statistics-users' => 'Ἐγγεγραμμένοι [[Special:Listwiki_Users|χρώμενοι]]',
