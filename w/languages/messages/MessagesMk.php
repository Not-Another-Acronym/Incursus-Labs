...
'editinguser' => "Менување на корисничките права на корисникот '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'Мора да сте [[Special:wiki_UserLogin|најавени]] со администраторска корисничка сметка за да може да вршите промена на кориснички права.',
...
'statistics-users' => 'Регистрирани [[Special:Listwiki_Users|корисници]]',
...
'revertpage-nouser' => 'Вратени уредувања на (избришано корисничко име) на последната ревизија од [[wiki_User:$1|$1]]',
