...
'editinguser' => "Мењате корисничка права {{GENDER:$1|корисника|кориснице|корисника}} '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'Морате се [[Special:wiki_UserLogin|пријавити]] с администраторским налогом да бисте додали корисничка права.',
...
'statistics-users' => 'Уписани корисници ([[Special:Listwiki_Users|списак чланова]])',
...
'revertpage-nouser' => 'Враћене су измене корисника (корисничко име је уклоњено) на последњу измену члана [[wiki_User:$1|$1]]',
