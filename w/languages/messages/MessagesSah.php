...
'editinguser' => "[[wiki_User:$1|$1]]''' кыттааччы $2 быраабын уларытыы",
...
'userrights-nologin' => 'Эн дьон бырааптарын уларытаргар администратор быһыытынан [[Special:wiki_UserLogin|бэлиэтэниэхтээххин]].',
...
'statistics-users' => 'Бэлиэтэммит [[Special:Listwiki_Users|кыттааччы]] ахсаана',
...
'revertpage-nouser' => 'Бу киһи (аата көстүбэт) уларытыылара бу киһи барылыгар төннөрүлүннүлэр [[wiki_User:$1|$1]]',
