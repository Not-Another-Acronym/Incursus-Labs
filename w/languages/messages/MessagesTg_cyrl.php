...
'editinguser' => "Дар ҳоли вироиши корбар '''[[wiki_User:$1|$1]]''' ([[wiki_User talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
...
'userrights-nologin' => 'Шумо бояд бо як ҳисоби корбарӣ дорои ихтиёроти мудириятӣ [[Special:wiki_UserLogin|ба систем вуруд кунед]], то битавонед ихтиёроти корбаронро таъйид кунед.',
...
'statistics-users' => '[[Special:Listwiki_Users|Корбарони]] сабтиномшуда',
