...
'editinguser' => "تغییر اختیارات کاربری کاربر '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'شما باید با یک حساب کاربری مدیر [[Special:wiki_UserLogin|به سامانه وارد شوید]] تا بتوانید اختیارات کاربران را تعیین کنید.',
...
'statistics-users' => '[[Special:Listwiki_Users|کاربران]] ثبت‌نام کرده',
...
'revertpage-nouser' => 'ویرایش‌های انجام‌شده توسط (نام کاربری حذف شده‌است) به آخرین ویرایش [[wiki_User:$1|$1]] واگردانی شد.',
