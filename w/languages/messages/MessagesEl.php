...
'editinguser' => "Αλλαγή δικαιωμάτων χρήστη του χρήστη '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'Πρέπει να [[Special:wiki_UserLogin|συνδεθείτε]] με έναν λογαριασμό διαχειριστή συστήματος ώστε να ορίσετε δικαιώματα χρηστών.',
...
'statistics-users' => 'Εγγεγραμμένοι [[Special:Listwiki_Users|χρήστες]]',
...
'revertpage-nouser' => 'Αναστράφηκαν οι επεξεργασίες από τον (όνομα χρήστη αφαιρέθηκε) στη τελευταία έκδοση από τον/την [[wiki_User:$1|$1]]',
