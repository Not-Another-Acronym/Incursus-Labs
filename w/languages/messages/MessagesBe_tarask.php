...
'editinguser' => "Зьмена правоў {{GENDER:$1|удзельніка|удзельніцы}} '''[[wiki_User:$1|$1]]''' $2",
...
'userrights-nologin' => 'Вы павінны [[Special:wiki_UserLogin|ўвайсьці ў сыстэму]] як адміністратар, каб прызначаць правы ўдзельнікам.',
...
'statistics-users' => '[[Special:Listwiki_Users|Зарэгістраваныя ўдзельнікі]]',
...
'revertpage-nouser' => 'Рэдагаваньні (імя ўдзельніка выдаленае) скасаваныя да папярэдняй вэрсіі [[wiki_User:$1|$1]]',
