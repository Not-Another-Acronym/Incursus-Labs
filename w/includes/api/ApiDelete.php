...
class ApiDelete extends ApiBase {
	...
	/**
	 * @param $title Title
	 * @param $user wiki_User doing the action
	 * @param $token String
	 * @return array
	 */
	 ...
	 * @return Status
	 */
	public static function delete( Page $page, wiki_User $user, $token, &$reason = null ) {
		$title = $page->getTitle();
	 ...
	 * @return Status
	 */
	public static function deleteFile( Page $page, wiki_User $user, $token, $oldimage, &$reason = null, $suppress = false ) {
		$title = $page->getTitle();
		$errors = self::getPermissionsError( $title, $user, $token );
		if ( count( $errors ) ) {
			return $errors;
