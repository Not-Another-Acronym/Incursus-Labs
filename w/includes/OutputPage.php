...
" );
	...
	public function getJSVars() {
		...
		$vars = array(
			...
			'wgwiki_UserName' => $this->getUser()->isAnon() ? null : $this->getUser()->getName(),
			'wgwiki_UserGroups' => $this->getUser()->getEffectiveGroups(),
	...
	public function getHeadLinksArray( $addContentType = false ) {
		...
		if ( $wgUniversalEditButton && $this->isArticleRelated() ) {
			$user = $this->getUser();
			if ( $this->getTitle()->quickwiki_UserCan( 'edit', $user )
				&& ( $this->getTitle()->exists() || $this->getTitle()->quickwiki_UserCan( 'create', $user ) ) ) {
