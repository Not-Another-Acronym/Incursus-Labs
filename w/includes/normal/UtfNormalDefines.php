...
if(!defined('UNICODE_HANGUL_LBASE'))
	define( 'UNICODE_HANGUL_LBASE', 0x1100 );
if(!defined('UNICODE_HANGUL_VBASE'))
	define( 'UNICODE_HANGUL_VBASE', 0x1161 );
if(!defined('UNICODE_HANGUL_TBASE'))
	define( 'UNICODE_HANGUL_TBASE', 0x11a7 );

if(!defined('UNICODE_HANGUL_LCOUNT'))
	define( 'UNICODE_HANGUL_LCOUNT', 19 );
if(!defined('UNICODE_HANGUL_VCOUNT'))
	define( 'UNICODE_HANGUL_VCOUNT', 21 );
if(!defined('UNICODE_HANGUL_TCOUNT'))
	define( 'UNICODE_HANGUL_TCOUNT', 28 );
if(!defined('UNICODE_HANGUL_NCOUNT'))
