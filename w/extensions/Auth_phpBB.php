<?php
    ...
    if (!class_exists('AuthPlugin') || !interface_exists('iAuthPlugin'))
    {
         ...
         *
         */
        require_once getenv('MW_INSTALL_PATH') . 'includes/AuthPlugin.php';

        /**
         * Auth Plug-in Interface
         *
         */
        require_once getenv('MW_INSTALL_PATH') . 'extensions/iAuthPlugin.php';
    ...
    if (!class_exists('PasswordHash'))
    {
         ...
         *
         */
        require_once getenv('MW_INSTALL_PATH') . 'extensions/PasswordHash.php';
    }
